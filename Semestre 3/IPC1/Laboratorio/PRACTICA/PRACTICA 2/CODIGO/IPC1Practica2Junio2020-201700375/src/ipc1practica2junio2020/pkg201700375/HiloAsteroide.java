...
import static ipc1practica2junio2020.pkg201700375.JuegoReal.CPunteo;
...
public class HiloAsteroide extends Thread {
    ...
    public static int FAster,CAster;

    public HiloAsteroide(int FilaIni, int ColIni, int MilisegundosTimer) {
        this.FilaIni = FilaIni;
        this.ColIni = ColIni;
        this.MilisegundosTimer = MilisegundosTimer;
        FilaAct = FilaIni;
        ImageIcon INI = new ImageIcon(new ImageIcon("src/Assets/Asteroide.png").getImage().getScaledInstance(MatrizVisualTablero[FilaAct][ColIni].getWidth(), MatrizVisualTablero[FilaAct][ColIni].getHeight(), Image.SCALE_DEFAULT));
