...
import static ipc1practica2junio2020.pkg201700375.JuegoReal.CVel;
...
//import static ipc1practica2junio2020.pkg201700375.JuegoReal.Invisible;
import static ipc1practica2junio2020.pkg201700375.JuegoReal.MilisCaidaObjetos;
 ...
 */
public class HiloCaracol extends Thread {
    private int FilaIni;
    private int ColIni;
    private int FilaAct;
    ...
    public HiloCaracol(int FilaIni, int ColIni, int MilisegundosTimer) {
        this.FilaIni = FilaIni;
        this.ColIni = ColIni;
        this.MilisegundosTimer = MilisegundosTimer;
        FilaAct = FilaIni;
        ImageIcon INI = new ImageIcon(new ImageIcon("src/Assets/Caracol.jpeg").getImage().getScaledInstance(MatrizVisualTablero[FilaAct][ColIni].getWidth(), MatrizVisualTablero[FilaAct][ColIni].getHeight(), Image.SCALE_DEFAULT));
...
//               if (Invisible = false){
                  //Validaciones
                  switch (MilisCaidaObjetos){
                      case 200:
                          MilisCaidaObjetos = 400;
                          CVel = 4;
                          break;
                      case 400:
                          MilisCaidaObjetos = 600;
                          CVel = 3;
                          break;
                      case 600:
                          MilisCaidaObjetos = 800;
                          CVel = 2;
                          break;
                      case 800:
                          MilisCaidaObjetos = 1000;
                          CVel = 1;
                          break;
                      case 1000:
                          MilisCaidaObjetos = 1000;
