...
import static ipc1practica2junio2020.pkg201700375.JuegoReal.CPoder;
 ...
 */
public class HiloOjo extends Thread {
    private int FilaIni;
    private int ColIni;
    private int FilaAct;
    ...
    public HiloOjo(int FilaIni, int ColIni, int MilisegundosTimer) {
        this.FilaIni = FilaIni;
        this.ColIni = ColIni;
        this.MilisegundosTimer = MilisegundosTimer;
        FilaAct = FilaIni;
        ImageIcon INI = new ImageIcon(new ImageIcon("src/Assets/Ojo.png").getImage().getScaledInstance(MatrizVisualTablero[FilaAct][ColIni].getWidth(), MatrizVisualTablero[FilaAct][ColIni].getHeight(), Image.SCALE_DEFAULT));
