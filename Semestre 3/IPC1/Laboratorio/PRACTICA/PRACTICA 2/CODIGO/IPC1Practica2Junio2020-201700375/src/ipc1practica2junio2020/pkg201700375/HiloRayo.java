 ...
 */
public class HiloRayo extends Thread {
    private int FilaIni;
    private int ColIni;
    private int FilaAct;
    ...
    public HiloRayo(int FilaIni, int ColIni, int MilisegundosTimer) {
        this.FilaIni = FilaIni;
        this.ColIni = ColIni;
        this.MilisegundosTimer = MilisegundosTimer;
        FilaAct = FilaIni;
        ImageIcon INI = new ImageIcon(new ImageIcon("src/Assets/Rayo.jpg").getImage().getScaledInstance(MatrizVisualTablero[FilaAct][ColIni].getWidth(), MatrizVisualTablero[FilaAct][ColIni].getHeight(), Image.SCALE_DEFAULT));
