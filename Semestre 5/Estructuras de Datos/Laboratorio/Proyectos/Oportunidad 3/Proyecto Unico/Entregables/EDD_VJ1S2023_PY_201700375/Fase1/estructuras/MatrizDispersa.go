...
func (m *Matriz) Reporte() {
	...
	fmt.Println(texto)
	m.CrearArchivo(nombre_archivo)
	m.EscribirArchivo(nombre_archivo, texto)
	m.EjecutarComandos(nombre_archivo, nombre_imagen)
}

func (m *Matriz) CrearArchivo(NombreArchivo string) {
...
func (m *Matriz) EscribirArchivo(NombreArchivo string, StringGraphViz string) {
...
func (m *Matriz) EjecutarComandos(NombreArchivo string, NombreImagen string) {
...
func (m *Matriz) GenerarImagen(nombre_imagen string) {
	archivoCSS := "csv/" + nombre_imagen + "/" + nombre_imagen + ".css"
	...
	m.CrearArchivo(archivoCSS)
	m.EscribirArchivo(archivoCSS, contenidoCSS)
}
...
func (m *Matriz) generarHTML(nombre_imagen string) {
	...
	contenidoHTML += "</div> \n </body> \n </html> \n"
	m.CrearArchivo(archivoHTML)
	m.EscribirArchivo(archivoHTML, contenidoHTML)
}
