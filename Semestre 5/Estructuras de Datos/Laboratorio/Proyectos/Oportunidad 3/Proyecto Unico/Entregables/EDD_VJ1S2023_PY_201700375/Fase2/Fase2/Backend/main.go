...
import (
	"Fase2/Backend/estructuras/ArbolAVL"
	"Fase2/Backend/estructuras/ColaPedidos"
	"Fase2/Backend/estructuras/Facturas"
	"Fase2/Backend/estructuras/Grafo"
	"Fase2/Backend/estructuras/Lista"
	"Fase2/Backend/estructuras/Matriz"
	"Fase2/Backend/estructuras/Peticiones"
	"Fase2/Backend/estructuras/TablaHash"
	"encoding/base64"
	"fmt"
	"io/ioutil"
...
func main() {
	...
	app.Post("/login", func(c *fiber.Ctx) error {
		...
		if usuario.Username == "ADMIN_201700375" && usuario.Password == "Admin" {
