        ...
        <div className="form-signin1">
            <div className="text-center">
                  ...
                  <h1 className="h3 mb-3 fw-normal">Dashboard Empleado {localStorage.getItem("empleado")}</h1>
                    ...
                    <input type="text" id="userI" className="form-control" placeholder="" required
                    onChange={e => setPago(e.target.value)} 
                    value={pago}  
                    autoFocus/>
                    <br/>
                    <center><button className="w-100 btn btn-success" type="submit">Generar Pago</button></center>
                    <br/>
